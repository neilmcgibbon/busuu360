...
function e(e, r, o) {
    ...
    if (arguments.length > 1) {
        ...
        for (var p = 0, h = e.arcs.length; h > p; ++p)
            u.push([p]);
    return n(e, {
...
function n(t, e) {
    function n(t, e) {
        e.length && e.pop();
        for (var n, o = h[0 > t?~t: t], a = 0, i = o.length, c = 0, s = 0; i > a; ++a)
    ...
    function a(t) {
        for (var e = [], r = 0, o = t.length; o > r; ++r)
            n(t[r], e);
        return 2 > e.length && e.push(e[0]), e
    }
    function i(t) {
        for (var e = a(t); 4 > e.length;)
            e.push(e[0]);
        return e
    }
    function c(t) {
    ...
    var u = t.transform, f = u.scale[0], l = u.scale[1], d = u.translate[0], p = u.translate[1], h = t.arcs, v = {
        Point: function(t) {
